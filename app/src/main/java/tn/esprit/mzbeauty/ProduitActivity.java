...
public class ProduitActivity extends AppCompatActivity {
    ...
    private class Content extends AsyncTask<Void,Void,Void>{
        ...
        protected void onPreExecute() {
            ...
            progressBar.startAnimation(AnimationUtils.loadAnimation(ProduitActivity.this, android.R.anim.fade_in));
        }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            progressBar.startAnimation(AnimationUtils.loadAnimation(ProduitActivity.this
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                String url = "https://www.jumia.com.tn/soin-peau-visage/";
